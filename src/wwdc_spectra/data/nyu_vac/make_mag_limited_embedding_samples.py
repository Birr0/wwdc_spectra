...
def main():
    ...
    for model_no in ["7655991_0", "7655991_1", "7655991_2"]:
        jts = {}
        for split in splits:
        ...
        for split in splits:
            ...
            mask_box = (z_embed > 0) & (z_embed <= z_cut) & (M_r <= M_lim_zmax).reshape(-1) & mask_z_agree
        ...
        ds_dict.save_to_disk(f"{DATA_ROOT}/sdss/magnitude_limited_embeddings_{model_no}/z={z_cut.item():.3f}")
    '''
    ds_dict.push_to_hub(
